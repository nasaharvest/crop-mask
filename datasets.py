...
class MalawiCorrectiveLabels2020(LabeledDataset):
    def load_labels(self) -> pd.DataFrame:
        ...
        df6 = pd.read_csv(Malawi_dir / "Malawi_new points -Stephen_2.csv")
        df7 = pd.read_csv(Malawi_dir / "Malawi_new points -Stephen_3.csv")
        df8 = pd.read_csv(Malawi_dir / "Malawi_new points -Stephen_4.csv")
        df9 = pd.read_csv(Malawi_dir / "Malawi_new points charles_1.csv")
        df10 = pd.read_csv(Malawi_dir / "Malawi_new points charles_2.csv") 
        df11 = pd.read_csv(Malawi_dir / "Malawi_new points charles_3.csv") 
        df12 = pd.read_csv(Malawi_dir / "Malawi_new points Stephen_5.csv") 
        df13 = pd.read_csv(Malawi_dir / "Malawi_new points sungeni mnensa_1.csv")
        df14 = pd.read_csv(Malawi_dir / "Malawi_new points sungeni Mnensa_2.csv")
        df15 = pd.read_csv(Malawi_dir / "Malawi_new points_Blake.csv")
        df16 = pd.read_csv(Malawi_dir / "Malawi_new points_Chirwa L.csv")
        df17 = pd.read_csv(Malawi_dir / "Malawi_new points_Powel_Mbilima.csv")
        df18 = pd.read_csv(Malawi_dir / "Malawi_new points_segula_1.csv")
        df19 = pd.read_csv(Malawi_dir / "Malawi_new points_segula.csv")
