...
class Uganda_NorthCEO2018(LabeledDataset):
    def load_labels(self) -> pd.DataFrame:
        raw_folder = raw_dir / "Uganda_North_2018"
        df1 = pd.read_csv(
            raw_folder
            / "ceo-UNHCR-North-Uganda-Feb-2018---Feb-2019-(Set-1)-sample-data-2025-01-18.csv"
        )
        df2 = pd.read_csv(
            raw_folder
            / "ceo-UNHCR-North-Uganda-Feb-2018---Feb-2019-(Set-2)-sample-data-2025-01-18.csv"
        )
        df = pd.concat([df1, df2])
        ...
        df[START], df[END] = date(2018, 1, 1), date(2019, 12, 31)
        df[SUBSET] = train_val_test_split(df.index, 0.3, 0.3)
        return df
...
class Uganda_NorthCEO2023(LabeledDataset):
    def load_labels(self) -> pd.DataFrame:
        raw_folder = raw_dir / "Uganda_North_2023"
        df1 = pd.read_csv(
            raw_folder
            / "ceo-UNHCR-North-Uganda-Feb-2023---Feb-2024-(Set-1)-sample-data-2025-04-02.csv"
        )
        df2 = pd.read_csv(
            raw_folder
            / "ceo-UNHCR-North-Uganda-Feb-2023---Feb-2024-(Set-2)-sample-data-2025-04-02.csv"
        )
        df = pd.concat([df1, df2])
        ...
        df[START], df[END] = date(2023, 1, 1), date(2024, 12, 31)
        df[SUBSET] = train_val_test_split(df.index, 0.3, 0.3)
        return df
    
class Uganda_NorthCEO2024(LabeledDataset):
    def load_labels(self) -> pd.DataFrame:
        raw_folder = raw_dir / "Uganda_North_2024"
        df1 = pd.read_csv(
            raw_folder
            / "ceo-UNHCR-North-Uganda-Feb-2024---Feb-2025-(Set-1)-sample-data-2025-08-19.csv"
        )
        df2 = pd.read_csv(
            raw_folder
            / "ceo-UNHCR-North-Uganda-Feb-2024---Feb-2025-(Set-2)-sample-data-2025-08-19.csv"
        )
        df = pd.concat([df1, df2])
        ...
        df[START], df[END] = date(2024, 1, 1), date(2025, 4, 30)
        df[SUBSET] = train_val_test_split(df.index, 0.3, 0.3)
        return df
...
class MalawiCropArea2020(LabeledDataset):
    def load_labels(self) -> pd.DataFrame:
...
class TanzaniaCropArea2019(LabeledDataset):
    def load_labels(self) -> pd.DataFrame:
...
class FranceCropArea2020(LabeledDataset):
    def load_labels(self) -> pd.DataFrame:
