...
labeled_datasets = [
    ...
    LabeledDataset(
        dataset="Ethiopia_Tigray",
        country="Ethiopia",
        processors=(
            Processor(filename="tigray/tigrayWW_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigray/tigrayWW_crop2.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigray/tigrayWW_forest.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigray/tigrayWW_forest2.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigray/tigrayWW_shrub.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigray/tigrayWW_shrub2.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigray/tigrayWW_sparse.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigray/tigrayWW_sparse2.shp", crop_prob=0.0, end_year=2020),
            Processor(
            ...
            Processor(filename="tigraySHP/nonFallowCrop2020.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayCE_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayCW_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayCW_forest.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayCW_shrub.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayEE_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayEW_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayEW_shrub.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayNWC_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayNWE_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayNWE_sparse.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayNWW_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayNWW_crop2.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayNWW_forest.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayNWW_shrub.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayNWW_shrub2.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayNWW_sparse.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayNWW_sparse2.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigraySE_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigraySE_forest.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigraySE_shrub.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigraySE_sparse.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayWW_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayWW_crop2.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayWW_crop3.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayWW_forest.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayWW_forest2.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayWW_shrub.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayWW_shrub2.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayWW_sparse.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayWW_sparse2.shp", crop_prob=0.0, end_year=2020),
            Processor(filename="tigraySHP/tigrayWW_water.shp", crop_prob=0.0, end_year=2020),
        ),
    ),
    LabeledDataset(
        dataset="Ethiopia_Western_Tigray_and_Bure",
        country="Ethiopia",
        processors=(
            Processor(filename="ethiopia_crop.shp", crop_prob=1.0, end_year=2020),
            Processor(filename="ethiopia_noncrop.shp", crop_prob=0.0, end_year=2020),
        ),
    ),
    LabeledDataset(
