...
with open('windows_logs.csv','a') as file:
    writer=csv.writer(file)
    if os.stat('windows_logs.csv').st_size==0:
        writer.writerow(['Model_name','Batch_size','total_execution_time','Peak_cpu_percent','Peak_memory_percent','peak_proc_cpu','peak_proc_mem'])
    data=[model_name,n,end_time-start_time,peak_sys_cpu,peak_sys_mem,peak_proc_cpu,peak_proc_mem]
